...
# Reference to the current boss (Luna)
var luna: Node = null
var solaris: Node = null
var lunaris: Node = null
var aetherion: Node= null
# Signal to notify when a player chooses an option
signal choice_selected(option)

# Example function called by your dialogue UI when a choice is clicked
func select_choice(option_data: Dictionary) -> void:
	# option_data should contain at least a "text" key
	emit_signal("choice_selected", option_data)
